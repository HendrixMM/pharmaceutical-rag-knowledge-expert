...
class TestAccuracyRegressionDetection:
    ...
    def test_accuracy_regression_5_percent_drop(self):
        ...
        assert "accuracy_regression" in flags, "5.88% accuracy drop should trigger regression"
    ...
    def test_accuracy_improvement_no_regression(self):
        ...
        assert "accuracy_regression" not in flags, "Accuracy improvement should not trigger regression"
    ...
    def test_accuracy_small_drop_no_regression(self):
        ...
        assert "accuracy_regression" not in flags, "Drop < 5% should not trigger regression"
    ...
    def test_accuracy_boundary_case_exactly_5_percent(self):
        ...
        assert "accuracy_regression" in flags, "Exactly 5% drop should trigger regression (boundary)"
...
class TestCostRegressionDetection:
    ...
    def test_cost_regression_20_percent_increase(self):
        ...
        assert "cost_regression" in flags, "25% cost increase should trigger regression"
    ...
    def test_cost_decrease_no_regression(self):
        ...
        assert "cost_regression" not in flags, "Cost decrease should not trigger regression"
    ...
    def test_cost_small_increase_no_regression(self):
        ...
        assert "cost_regression" not in flags, "Cost increase < 20% should not trigger regression"
...
class TestLatencyRegressionDetection:
    ...
    def test_latency_decrease_no_regression(self):
        ...
        assert "latency_regression" not in flags, "Latency decrease should not trigger regression"
    ...
    def test_latency_small_increase_no_regression(self):
        ...
        assert "latency_regression" not in flags, "Latency increase < 50% should not trigger regression"
...
class TestMultipleRegressionsDetection:
    ...
    def test_multiple_regressions_detected(self):
        ...
        assert "accuracy_regression" in flags, "Should detect accuracy regression"
        assert "cost_regression" in flags, "Should detect cost regression"
        assert "latency_regression" in flags, "Should detect latency regression"
        assert len(flags) == 3, f"Should detect all 3 regressions, got {len(flags)}"
    ...
    def test_no_regression_all_metrics_improved(self):
        ...
        assert len(flags) == 0, f"No regressions should be detected when all metrics improve, got {flags}"
...
class TestEdgeCases:
    ...
    def test_zero_baseline_accuracy(self):
        ...
        assert "accuracy_regression" not in flags, "Zero baseline should not trigger false positive"
    ...
    def test_zero_baseline_cost(self):
        ...
        # Should not crash or trigger false positive
        assert "cost_regression" not in flags, "Zero baseline should not trigger false positive"
    ...
    def test_zero_baseline_latency(self):
        ...
        # Should not crash or trigger false positive
        assert "latency_regression" not in flags, "Zero baseline should not trigger false positive"
    ...
    def test_equal_baseline_and_current_values(self):
        ...
        assert len(flags) == 0, f"Equal values should produce no regression, got {flags}"
    ...
    def test_negative_percentage_change(self):
        ...
        assert abs(accuracy_change_pct - 10.0) < 0.01, f"10% improvement should show as +10%, got {accuracy_change_pct}"

        # No regression should be flagged for improvement
        assert "accuracy_regression" not in flags, "Improvement should not trigger regression"
...
class TestPercentageCalculationAccuracy:
    ...
    def test_percentage_calculation_5_percent_drop(self):
        ...
        assert abs(expected_pct - (-5.0)) < 0.01, f"5% drop should calculate as -5.0%, got {expected_pct}"
    ...
    def test_percentage_calculation_20_percent_increase(self):
        ...
        expected_pct = ((current - baseline) / baseline) * 100
        assert expected_pct == 20.0, f"20% increase should calculate as +20.0%, got {expected_pct}"
    ...
    def test_percentage_calculation_50_percent_increase(self):
        ...
        expected_pct = ((current - baseline) / baseline) * 100
        assert expected_pct == 50.0, f"50% increase should calculate as +50.0%, got {expected_pct}"
    ...
    def test_percentage_calculation_prevents_divide_by_zero_bug(self):
        ...
        assert correct_pct == 5.0, f"5% cost increase should calculate correctly as 5.0%, got {correct_pct}"
